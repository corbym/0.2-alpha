...
public abstract class JMudEngine extends Thread {
	...
	static final int DEFAULT_MUD_HEARTBEAT_LENGTH_MS = 2000;
	...
	public static void main(String[] args) {
		...
		logger.info("arguments: " + argsList.toString());
		if (!argsList.contains("-nocache")) {
	...
	protected void savePlayers() {
		...
		while (i.hasNext()) {
			LoginShell o = i.next();
			getObjectAttendant().savePlayerData(o.getPlayer());
			try {
