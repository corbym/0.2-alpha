...
public class RegistryTest extends TestCase {
    ...
    /*
     * Test method for
     * 'org.groovymud.object.registry.Registry.addRoom(AbstractRoom)'
     */
    public void testAddRoom() {
        ...
        Registry reg = new Registry() {
            ...
            @Override
            protected Observable castRoomToObservable(Room room) {
                // TODO Auto-generated method stub
                return obs;
            }
        };
        mockRoom.getScriptFileName();
        mockCtrl.setDefaultReturnValue("tomb/tomb1.groovy");
        mockRoom.setCurrentContainer(reg);
        mockCtrl.setDefaultVoidCallable();
        mockCtrl.replay();
        inv.addMudObject("tomb/tomb1.groovy", mockRoom);
    ...
    public void testNotifyContents() {
        ...
        Registry reg = new Registry() {
            ...
            @Override
            public HashSet<MudObject> getItems() {
                // TODO Auto-generated method stub
                return items;
            }
        };
    ...
    public void testDoUpdate() {
        ...
        final MovementEvent moveEvent = new MovementEvent(null, "", null, null);
